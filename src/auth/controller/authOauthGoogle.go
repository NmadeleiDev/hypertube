...
// 	Response []responseGoogle `json:"response"`
// }
...
**	-- Проверено
 */
func authOauthGoogle(w http.ResponseWriter, r *http.Request) {
	conf, Err := getConfig()
	if Err != nil {
		logger.Error(r, Err)
		http.Redirect(w, r,
	...
	params, Err := parseRequestParamsGoogle(r)
	if Err != nil {
	...
	fmt.Println("parsed request params", params)
	/*
 ...
 */
func parseRequestParamsGoogle(r *http.Request) (requestParams, *errors.Error) {
